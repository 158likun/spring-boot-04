...
public class ShoopingCar {
    private List<CarsInformation> carsInformation;
    ...
    public List<CarsInformation> getCarsInformation() {
        return carsInformation;
    }

    public void setCarsInformation(List<CarsInformation> carsInformation) {
